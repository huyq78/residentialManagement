...
export default function CardCreateCitizen() {
  ...
  const handleChange = (event) =>
    ...
    const handleSubmit = (event) =>{
      ...
      fetch("http://localhost:5000/citizen/create", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          card_id: inputText.card_id,
        location: inputText.location,
        date: inputText.date,
        expiration: inputText.expiration,
